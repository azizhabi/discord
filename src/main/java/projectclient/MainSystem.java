...
public class MainSystem {
    ...
    public void SignIn(JSONObject jsonObject) throws InterruptedException {
...
//        String phoneNumber = scanner.nextLine();
        ...
        json.put("Username", jsonObject.getString("Username"));
        json.put("password", jsonObject.getString("password"));
        json.put("phoneNumber", "123456778");
        json.put("Email", jsonObject.getString("Email"));
...
//        account();
    ...
    public void SignUp(String name, String password) throws InterruptedException {
        System.out.println("alisehfa rahimi is the best ");
